...
<div className="max-w-sm bg-white rounded-lg ml-6 mr-6 mb-6 card">
    ...
    <div className="px-5 pb-5">
            <h5 className="text-lg font-semibold tracking-tight text-zinc-900 font-fredericka">{title}</h5>
        <div className="flex items-center mt-5 mb-3">
            ...
            <svg className="w-5 h-5 text-yellow-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
            <svg className="w-5 h-5 text-yellow-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
            <span className="bg-zinc-900 text-white text-xs font-semibold mr-2 px-2.5 py-0.5 rounded ml-3 font-fredericka">5.0</span>
        </div>
        <div className="flex justify-between items-center">
            <span className="text-xl font-bold text-zinc-900 font-fredericka">${price}</span>
            <Link to= {`/tequila/${id}`} className="btn px-3 py-2 text-white bg-zinc-900 hover:text-zinc-900 hover:bg-white text-xs font-bold rounded transition-all duration-500 font-fredericka">Ver Detalle</Link>
        </div>
    </div>
</div>
  )}
